...
def get_source_dataset_base(replication_task: ReplicationTask) -> str:
...
def get_source_dataset(replication_task: ReplicationTask, dst_dataset: str) -> str:
...
def get_target_dataset(replication_task: ReplicationTask, src_dataset: str) -> str:

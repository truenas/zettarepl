...
@pytest.mark.parametrize("snapshot_to_destroy,error_text", [
    ...
    (
        ...
        (
            ...
            "data/dst/child2@2021-08-23_19-30 was not transferred. Please run `zfs destroy -r data/dst@2021-08-23_19-30` "
...
def test_properties_exclude(take_new_snapshot, snapshot_to_destroy, error_text):
